...
winner for keeps; you rank and synthesise, then hand the field to `method-decide`.
...
- **Keep the losers legible.** Note why each was not the spine, in one line. That
  reasoning is what `method-decide` needs and what stops a discarded option being
